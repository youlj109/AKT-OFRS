function [avgF1_k_off1, avgAUC_k_off1, OA_k_off1, AA_k_off1, times_k_off1] = Fstream3(data_all, labels_all, train_ratio, k)
...
function [selected_index, timeUse] = FeatureStream(fea,~,m) 
%set training and testing data

%learning module
%example of Fast-OSFS for discrete data
[f,timeUse] = saola_z_test(fea,0.05);
