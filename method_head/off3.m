function [avgF1_k_off1, avgAUC_k_off1, OA_k_off1, AA_k_off1, times_k_off1] = off3(data, labels, train_ratio, k)
...
[fs_index,times_k_off1] = off3Methods(trainData, trainLabels, num_features);
...
function [fs_index,times_k_off1] = off3Methods(trainData, trainLabels, num_features)
tic
% Perform relieff
[RANKED, ~] = relieff(trainData,trainLabels,5);
times_k_off1 = toc;
