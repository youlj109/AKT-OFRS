function [avgF1_k_off1, avgAUC_k_off1, OA_k_off1, AA_k_off1, times_k_off1] = off1(data, labels, train_ratio, k)
...
[fs_index,times_k_off1] = off1Methods(trainData, trainLabels, num_features);
...
function [fs_index,times_k_off1] = off1Methods(trainData, trainLabels, num_features)
tic
[RANKED, ~, ~] = InfFS_S(trainData, trainLabels , [0.5 0.3 0.2]);
times_k_off1 = toc;
