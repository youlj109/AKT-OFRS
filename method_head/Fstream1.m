function [avgF1_k_off1, avgAUC_k_off1, OA_k_off1, AA_k_off1, times_k_off1] = Fstream1(data_all, labels_all, train_ratio, k)
...
[selected_features,timeUse]=fast_osfs_z(traindata,class_index,alpha);
selected_index = selected_features(1:min(length(selected_features),m));